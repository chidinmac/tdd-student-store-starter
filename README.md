...
[StudentStore](https://user-images.githubusercontent.com/87202479/176552451-2123af87-ac59-4be0-a246-cef75a55ebef.gif)
[StudentStore2.gif.zip](https://github.com/chidinmac/tdd-student-store-starter/files/9032164/StudentStore2.gif.zip)
...
The Whole concept of react that was discussed in the labs was effective in this project: props, components e.t.c

* If you had more time, what would you have done differently? Would you have added additional features? Changed the way your project responded to a particular event, etc.

I would have added the react router effect for my pages, and would have made my nav bar to scroll to what ever section was clicked on its links

* Reflect on your project demo, what went well? Were there things that maybe didn't go as planned? Did you notice something that your peer did that you would like to try next time?

Majority of the functionalities went well, although after spending long time debugging, I planned to do the react router effect but did not do that, I woul like to complet the react router effect next time.
...
<p>Shout Out to Mr Phineas and Mr Yilika for the aid in debugging , explanations, demos, and even the example website. They were all helpful in learning the concepts of react</p>
<p>Shout out to Mr. Ramu for helping me unconsciously set a timing for each section of the project</p>
